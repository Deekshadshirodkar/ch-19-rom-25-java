class ForestSafariRunner {
    ...
    public static void main(String[] args) {
        ...
        safari1.safariName = "Tiger Trail";
        safari1.location = "Bandipur";
        safari1.numberOfAnimals = 45;
        safari1.jeepAvailable = true;
        safari1.safariDurationHours = 2;
        safari1.ticketPrice = 1200.0;
        ...
        safari2.location = "Nagarhole";
        safari2.numberOfAnimals = 60;
        safari2.jeepAvailable = false;
        safari2.safariDurationHours = 1;
        safari2.ticketPrice = 900.0;
        ...
        safari3.location = "Kabini";
        safari3.numberOfAnimals = 30;
        safari3.jeepAvailable = true;
        safari3.safariDurationHours = 3;
        safari3.ticketPrice = 1500.0;
        ...
        safari4.jeepAvailable = true;
        safari4.safariDurationHours = 2;
        safari4.ticketPrice = 1000.0;
        ...
        safari5.location = "Kaziranga";
        safari5.numberOfAnimals = 35;
        safari5.jeepAvailable = true;
        safari5.safariDurationHours = 2;
        ...
        safari6.location = "Satpura";
        safari6.numberOfAnimals = 22;
        safari6.jeepAvailable = false;
        safari6.safariDurationHours = 1;
        safari6.ticketPrice = 800.0;
        ...
        safari7.location = "Jim Corbett";
        safari7.numberOfAnimals = 50;
        safari7.jeepAvailable = true;
        safari7.safariDurationHours = 3;
        ...
        safari8.location = "Kuno";
        safari8.numberOfAnimals = 18;
        safari8.jeepAvailable = true;
        safari8.safariDurationHours = 2;
        safari8.ticketPrice = 1400.0;
        ...
        safari9.jeepAvailable = false;
        safari9.safariDurationHours = 1;
        safari9.ticketPrice = 900.0;
        ...
        safari10.location = "Bandipur";
        safari10.numberOfAnimals = 32;
        safari10.jeepAvailable = true;
        safari10.safariDurationHours = 3;
        safari10.ticketPrice = 1800.0;
        ...
        safari11.location = "Africa Safari Park";
        safari11.numberOfAnimals = 40;
        safari11.jeepAvailable = true;
        safari11.safariDurationHours = 2;
        safari11.ticketPrice = 2200.0;
        ...
        safari12.location = "Tadoba";
        safari12.numberOfAnimals = 38;
        safari12.jeepAvailable = true;
        safari12.safariDurationHours = 3;
        safari12.ticketPrice = 1600.0;
        ...
        safari13.location = "Bhadra";
        safari13.numberOfAnimals = 25;
        safari13.jeepAvailable = false;
        safari13.safariDurationHours = 1;
        safari13.ticketPrice = 700.0;
        ...
        safari14.location = "Nagarhole";
        safari14.numberOfAnimals = 30;
        safari14.jeepAvailable = true;
        safari14.safariDurationHours = 2;
        safari14.ticketPrice = 1500.0;
        ...
        safari15.location = "Kenya";
        safari15.numberOfAnimals = 45;
        safari15.jeepAvailable = true;
        safari15.safariDurationHours = 4;
        safari15.ticketPrice = 2500.0;
        ...
        safari16.location = "Kanha";
        safari16.numberOfAnimals = 42;
        safari16.jeepAvailable = true;
        safari16.safariDurationHours = 2;
        safari16.ticketPrice = 1900.0;
        ...
        safari17.location = "Kerala";
        safari17.numberOfAnimals = 20;
        safari17.jeepAvailable = false;
        safari17.safariDurationHours = 1;
        safari17.ticketPrice = 950.0;
        ...
        safari18.location = "Pench";
        safari18.numberOfAnimals = 33;
        safari18.jeepAvailable = true;
        safari18.safariDurationHours = 2;
        safari18.ticketPrice = 1700.0;
        ...
        safari19.location = "Agumbe";
        safari19.numberOfAnimals = 15;
        safari19.jeepAvailable = false;
        safari19.safariDurationHours = 1;
        safari19.ticketPrice = 600.0;
        ...
        safari20.location = "Sundarbans";
        safari20.numberOfAnimals = 27;
        safari20.jeepAvailable = true;
        safari20.safariDurationHours = 2;
        safari20.ticketPrice = 1550.0;
